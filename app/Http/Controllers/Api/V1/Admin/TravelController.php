...
class TravelController extends Controller
{
     ...
     * @authenticated
     *
     * @bodyParam is_public boolean. Example: "1"
     * @bodyParam name string. Example: "My new travel"
     * @bodyParam description string. Example: "a 5-days 4-nights city tour of Cuzco"
     * @bodyParam number_of_days number. Example: "5"
     *
